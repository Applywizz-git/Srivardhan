      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Whether it’s a full-stack development project, cloud deployment, or system modernization — feel free to connect and discuss how we can collaborate.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">srivardhanmavoori@gmail.com</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">+1 (313) 413-8553</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Okemos MI</p>
                </div>
              </div>
            </div>
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-red-400 to-blue-500 px-8 py-3 rounded-lg font-semibold hover-glow transition-all duration-300"
              >
                Send Message
              </button>
            </form>
